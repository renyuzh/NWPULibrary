...
$(function () {
    table = $('#data_list').DataTable({
        "ajax": {
            "url": $("#basePath").val() + "admin/bookType/list",
            "type": "POST",
            "data": function (d) {
                return {
...
function add() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: $("#basePath").val() + 'admin/bookType/save',
        cache: false,
        data: param,
...
function showUpdate(id) {
    jQuery.ajax({
        type: 'POST',
        url: $("#basePath").val() + 'admin/bookType/findById',
        cache: false,
        data: {id: id},
        success: function (data) {
            $("#update_id").val(id);
            $("#update_tname").val(data.tname);
...
function update() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: $("#basePath").val() + 'admin/bookType/update',
        cache: false,
        data: param,
        success: function (data) {
            if (data == 1) {
...
function del() {
    jQuery.ajax({
        type: 'POST',
        url: $("#basePath").val() + 'admin/bookType/delete',
        cache: false,
        data: {
            id: $('#delete_id').val()
        },
