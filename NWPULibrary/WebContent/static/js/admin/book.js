...
$(function () {
    table = $('#data_list').DataTable({
        "ajax": {
            "url": $("#basePath").val() + "admin/book/list",
            "type": "POST",
            "data": function (d) {
                return {
                    "bno": $('#query_bno').val(),
...
function showDetail(id) {
    jQuery.ajax({
        type: 'POST',
        url: $("#basePath").val() + 'admin/book/findById',
        cache: false,
        data: {id: id},
...
function add() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: $("#basePath").val() + 'admin/book/save',
        cache: false,
        data: param,
        success: function (data) {
            if (data == 1) {
...
function update() {
    ...
    var param = {
        ...
        tid: $.trim($("#update_tid").val()),
        bno: $.trim($("#update_bno").val())
    }

    jQuery.ajax({
        type: 'POST',
        url: $("#basePath").val() + 'admin/book/update',
        cache: false,
        data: param,
        success: function (data) {
            if (data) {
...
function del() {
    jQuery.ajax({
        type: 'POST',
        url: $("#basePath").val() + 'admin/book/delete',
        cache: false,
        data: {
            id: $('#delete_id').val()
        },
